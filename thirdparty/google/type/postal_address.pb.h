...
#ifndef PROTOBUF_INCLUDED_google_2ftype_2fpostal_5faddress_2eproto
#define PROTOBUF_INCLUDED_google_2ftype_2fpostal_5faddress_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2ftype_2fpostal_5faddress_2eproto 
...
class PostalAddress : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.type.PostalAddress) */ {
 public:
  ...
  inline PostalAddress* New() const final {
    return CreateMaybeMessage<PostalAddress>(NULL);
  }

  PostalAddress* New(::google::protobuf::Arena* arena) const final {
...
#endif  // PROTOBUF_INCLUDED_google_2ftype_2fpostal_5faddress_2eproto
