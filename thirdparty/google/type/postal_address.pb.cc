...
static void InitDefaultsPostalAddress() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_PostalAddress =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsPostalAddress}, {}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_PostalAddress.base);
}
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/type/postal_address.proto", schemas, file_default_instances, TableStruct::offsets,
...
PostalAddress::PostalAddress()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_google_2ftype_2fpostal_5faddress_2eproto::scc_info_PostalAddress.base);
  SharedCtor();
...
const PostalAddress& PostalAddress::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2ftype_2fpostal_5faddress_2eproto::scc_info_PostalAddress.base);
...
void PostalAddress::InternalSwap(PostalAddress* other) {
  ...
  postal_code_.Swap(&other->postal_code_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  sorting_code_.Swap(&other->sorting_code_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  administrative_area_.Swap(&other->administrative_area_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  locality_.Swap(&other->locality_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  sublocality_.Swap(&other->sublocality_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::type::PostalAddress* Arena::CreateMaybeMessage< ::google::type::PostalAddress >(Arena* arena) {
