...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/type/date.proto", schemas, file_default_instances, TableStruct::offsets,
...
Date::Date()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_google_2ftype_2fdate_2eproto::scc_info_Date.base);
  SharedCtor();
...
Date::Date(::google::protobuf::Arena* arena)
  ...
  ::google::protobuf::internal::InitSCC(&protobuf_google_2ftype_2fdate_2eproto::scc_info_Date.base);
  SharedCtor();
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::type::Date* Arena::CreateMaybeMessage< ::google::type::Date >(Arena* arena) {
