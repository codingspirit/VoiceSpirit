...
::google::protobuf::internal::SCCInfo<1> scc_info_Color =
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/type/color.proto", schemas, file_default_instances, TableStruct::offsets,
...
const Color& Color::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2ftype_2fcolor_2eproto::scc_info_Color.base);
  ...
  if (this->has_alpha()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        4, this->_internal_alpha(), deterministic, target);
  }
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::type::Color* Arena::CreateMaybeMessage< ::google::type::Color >(Arena* arena) {
  return Arena::CreateInternal< ::google::type::Color >(arena);
}
}  // namespace protobuf
}  // namespace google
