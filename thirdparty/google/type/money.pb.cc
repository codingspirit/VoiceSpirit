...
::google::protobuf::internal::SCCInfo<0> scc_info_Money =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsMoney}, {}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_Money.base);
}
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/type/money.proto", schemas, file_default_instances, TableStruct::offsets,
...
Money::Money()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_google_2ftype_2fmoney_2eproto::scc_info_Money.base);
  SharedCtor();
...
const Money& Money::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2ftype_2fmoney_2eproto::scc_info_Money.base);
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::type::Money* Arena::CreateMaybeMessage< ::google::type::Money >(Arena* arena) {
