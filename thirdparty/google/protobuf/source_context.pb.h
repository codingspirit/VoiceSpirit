...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fprotobuf_2fsource_5fcontext_2eproto 
...
namespace google {
namespace protobuf {
template<> ::google::protobuf::SourceContext* Arena::CreateMaybeMessage<::google::protobuf::SourceContext>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace google {
namespace protobuf {
