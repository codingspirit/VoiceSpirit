...
#ifndef PROTOBUF_INCLUDED_google_2fassistant_2fembedded_2fv1alpha1_2fembedded_5fassistant_2eproto
#define PROTOBUF_INCLUDED_google_2fassistant_2fembedded_2fv1alpha1_2fembedded_5fassistant_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fassistant_2fembedded_2fv1alpha1_2fembedded_5fassistant_2eproto 
...
namespace google {
namespace protobuf {
template<> ::google::assistant::embedded::v1alpha1::AudioInConfig* Arena::CreateMaybeMessage<::google::assistant::embedded::v1alpha1::AudioInConfig>(Arena*);
template<> ::google::assistant::embedded::v1alpha1::AudioOut* Arena::CreateMaybeMessage<::google::assistant::embedded::v1alpha1::AudioOut>(Arena*);
template<> ::google::assistant::embedded::v1alpha1::AudioOutConfig* Arena::CreateMaybeMessage<::google::assistant::embedded::v1alpha1::AudioOutConfig>(Arena*);
template<> ::google::assistant::embedded::v1alpha1::ConverseConfig* Arena::CreateMaybeMessage<::google::assistant::embedded::v1alpha1::ConverseConfig>(Arena*);
template<> ::google::assistant::embedded::v1alpha1::ConverseRequest* Arena::CreateMaybeMessage<::google::assistant::embedded::v1alpha1::ConverseRequest>(Arena*);
template<> ::google::assistant::embedded::v1alpha1::ConverseResponse* Arena::CreateMaybeMessage<::google::assistant::embedded::v1alpha1::ConverseResponse>(Arena*);
template<> ::google::assistant::embedded::v1alpha1::ConverseResult* Arena::CreateMaybeMessage<::google::assistant::embedded::v1alpha1::ConverseResult>(Arena*);
template<> ::google::assistant::embedded::v1alpha1::ConverseState* Arena::CreateMaybeMessage<::google::assistant::embedded::v1alpha1::ConverseState>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace google {
namespace assistant {
...
class ConverseConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.assistant.embedded.v1alpha1.ConverseConfig) */ {
 public:
  ...
  inline ConverseConfig* New() const final {
    return CreateMaybeMessage<ConverseConfig>(NULL);
  }

  ConverseConfig* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<ConverseConfig>(arena);
  }
  ...
  private:
  const ::google::assistant::embedded::v1alpha1::AudioInConfig& _internal_audio_in_config() const;
  public:
  ...
  private:
  const ::google::assistant::embedded::v1alpha1::AudioOutConfig& _internal_audio_out_config() const;
  public:
  ...
  private:
  const ::google::assistant::embedded::v1alpha1::ConverseState& _internal_converse_state() const;
  public:
...
class ConverseState : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.assistant.embedded.v1alpha1.ConverseState) */ {
 public:
  ...
  inline ConverseState* New() const final {
    return CreateMaybeMessage<ConverseState>(NULL);
  }

  ConverseState* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<ConverseState>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
...
class ConverseResult : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.assistant.embedded.v1alpha1.ConverseResult) */ {
 public:
  ...
  inline ConverseResult* New() const final {
    return CreateMaybeMessage<ConverseResult>(NULL);
  }

  ConverseResult* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<ConverseResult>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
...
class ConverseRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.assistant.embedded.v1alpha1.ConverseRequest) */ {
 public:
  ...
  inline ConverseRequest* New() const final {
    return CreateMaybeMessage<ConverseRequest>(NULL);
  }

  ConverseRequest* New(::google::protobuf::Arena* arena) const final {
  ...
  private:
  const ::google::assistant::embedded::v1alpha1::ConverseConfig& _internal_config() const;
  public:
...
class ConverseResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.assistant.embedded.v1alpha1.ConverseResponse) */ {
 public:
  ...
  inline ConverseResponse* New() const final {
    return CreateMaybeMessage<ConverseResponse>(NULL);
  }

  ConverseResponse* New(::google::protobuf::Arena* arena) const final {
  ...
  private:
  const ::google::assistant::embedded::v1alpha1::AudioOut& _internal_audio_out() const;
  public:
  ...
  private:
  const ::google::assistant::embedded::v1alpha1::ConverseResult& _internal_result() const;
  public:
...
inline const ::google::assistant::embedded::v1alpha1::AudioInConfig& ConverseConfig::_internal_audio_in_config() const {
...
inline ::google::assistant::embedded::v1alpha1::AudioInConfig* ConverseConfig::mutable_audio_in_config() {
  ...
  if (audio_in_config_ == NULL) {
    auto* p = CreateMaybeMessage<::google::assistant::embedded::v1alpha1::AudioInConfig>(GetArenaNoVirtual());
    audio_in_config_ = p;
  }
...
inline const ::google::assistant::embedded::v1alpha1::AudioOutConfig& ConverseConfig::_internal_audio_out_config() const {
...
inline ::google::assistant::embedded::v1alpha1::AudioOutConfig* ConverseConfig::mutable_audio_out_config() {
  ...
  if (audio_out_config_ == NULL) {
    auto* p = CreateMaybeMessage<::google::assistant::embedded::v1alpha1::AudioOutConfig>(GetArenaNoVirtual());
    audio_out_config_ = p;
  }
...
inline const ::google::assistant::embedded::v1alpha1::ConverseState& ConverseConfig::_internal_converse_state() const {
...
inline ::google::assistant::embedded::v1alpha1::ConverseState* ConverseConfig::mutable_converse_state() {
  ...
  if (converse_state_ == NULL) {
    auto* p = CreateMaybeMessage<::google::assistant::embedded::v1alpha1::ConverseState>(GetArenaNoVirtual());
    converse_state_ = p;
  }
...
inline const ::google::assistant::embedded::v1alpha1::ConverseConfig& ConverseRequest::_internal_config() const {
...
inline ::google::assistant::embedded::v1alpha1::ConverseConfig* ConverseRequest::mutable_config() {
  if (!has_config()) {
    ...
    set_has_config();
    converse_request_.config_ = CreateMaybeMessage< ::google::assistant::embedded::v1alpha1::ConverseConfig >(
        GetArenaNoVirtual());
  }
...
inline void ConverseRequest::set_audio_in(::std::string&& value) {
  ...
  converse_request_.audio_in_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline void ConverseRequest::set_allocated_audio_in(::std::string* audio_in) {
  ...
  if (audio_in != NULL) {
    set_has_audio_in();
    converse_request_.audio_in_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), audio_in);
  }
...
inline const ::google::rpc::Status& ConverseResponse::_internal_error() const {
...
inline ::google::rpc::Status* ConverseResponse::mutable_error() {
  if (!has_error()) {
    ...
    set_has_error();
    converse_response_.error_ = CreateMaybeMessage< ::google::rpc::Status >(
        GetArenaNoVirtual());
  }
...
inline const ::google::assistant::embedded::v1alpha1::AudioOut& ConverseResponse::_internal_audio_out() const {
...
inline ::google::assistant::embedded::v1alpha1::AudioOut* ConverseResponse::mutable_audio_out() {
  if (!has_audio_out()) {
    clear_converse_response();
    set_has_audio_out();
    converse_response_.audio_out_ = CreateMaybeMessage< ::google::assistant::embedded::v1alpha1::AudioOut >(
        GetArenaNoVirtual());
  }
...
inline const ::google::assistant::embedded::v1alpha1::ConverseResult& ConverseResponse::_internal_result() const {
...
inline ::google::assistant::embedded::v1alpha1::ConverseResult* ConverseResponse::mutable_result() {
  if (!has_result()) {
    clear_converse_response();
    set_has_result();
    converse_response_.result_ = CreateMaybeMessage< ::google::assistant::embedded::v1alpha1::ConverseResult >(
        GetArenaNoVirtual());
  }
...
template <> struct is_proto_enum< ::google::assistant::embedded::v1alpha1::AudioInConfig_Encoding> : ::std::true_type {};
template <>
...
template <> struct is_proto_enum< ::google::assistant::embedded::v1alpha1::AudioOutConfig_Encoding> : ::std::true_type {};
template <>
...
template <> struct is_proto_enum< ::google::assistant::embedded::v1alpha1::ConverseResult_MicrophoneMode> : ::std::true_type {};
template <>
...
template <> struct is_proto_enum< ::google::assistant::embedded::v1alpha1::ConverseResponse_EventType> : ::std::true_type {};
template <>
...
#endif  // PROTOBUF_INCLUDED_google_2fassistant_2fembedded_2fv1alpha1_2fembedded_5fassistant_2eproto
