 ...
 public:
  ...
  class WithAsyncMethod_Converse : public BaseClass {
   ...
   public:
    ...
    ::grpc::Status Converse(::grpc::ServerContext* context, ::grpc::ServerReaderWriter< ::google::assistant::embedded::v1alpha1::ConverseResponse, ::google::assistant::embedded::v1alpha1::ConverseRequest>* stream)  override {
      abort();
